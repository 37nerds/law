...
const INITIAL_INTEGRATION_LIST = [
    ...
    },
    {
        ...
        isActive: false,
        description: "Meta Platforms, Inc., doing business as Meta and formerly named Facebook, Inc., and TheFacebook.",
    },
    {
        name: "Linkedin",
...
const Integration = () => {
    ...
    const updateIntegrationStatus = (index: number) => {
        ...
        notify("success", `${integration.name} ${integration.isActive ? "disabled" : "enabled"}`);
    };
