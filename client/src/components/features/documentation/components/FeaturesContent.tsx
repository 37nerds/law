    ...
    return (
        <>
            <article className="prose">
                ...
                <div>
                    This is used for showing long list contents like
                    notifications, settings etc.. We are using redux to show and
                    hide and it is single component and can be called from any
                    file with dispatch method. To add new content follow
                    following steps:
                    <ul>
                        <li>
                            Create new component file containing main body of
                            your content
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            following code inside switch code block
                            <br />
                            ...
                            <span className="mt-1 text-sm italic">
                                Here extraObject have variables that is passed
                                from parent component while calling
                                openRightDrawer method
                            </span>
                        </li>
                        <li>
                ...
                <p>
                    ...
                    etc... Also we can configure themes colors in config file,
                    for more documentation on themes checkout{" "}
                ...
                <div>
                    ...
                    just call openModal() function of modalSlice using dispatch.
                    <br />
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            code inside switch code block
                            <br />
                            <div className="mockup-code mt-4">
                                <pre className="my-0 py-0">
                                    <code>{`[RIGHT_DRAWER_TYPES.TEST_MODAL] : \n<TestModal closeModal={close} extraObject={extraObject}/>`}</code>
                                </pre>
                            </div>
                            <span className="mt-1 text-sm italic">
                                Here extraObject have variables that is passed
                                from parent component while calling openModal
                                method
                            </span>
                        </li>
                        <li>
                ...
                <p className="mt-4">
                    ...
                    message notification pass status as 1 and for showing error
                    message pass status as 0.
                </p>
